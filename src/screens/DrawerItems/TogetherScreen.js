...
import { Text, View, LayoutAnimation, UIManager, FlatList, StyleSheet, ActivityIndicator, Keyboard } from "react-native";
  ...
  return (
    <Svg width={168} height={24} {...props}>
      <G fill="none">
        ...
        <Path
          fill="#5468FF"
          d="M78.988.938h16.594a2.968 2.968 0 012.966 2.966V20.5a2.967 2.967 0 01-2.966 2.964H78.988a2.967 2.967 0 01-2.966-2.964V3.897A2.961 2.961 0 0178.988.938z"
        />
        <Path
          fill={colors.light}
      ...
      this.state.currentSearchTimeout = setTimeout(() => {
        if (this.state.index !== null) {
          this.state.index.search({
            ...
            hitsPerPage: 5,
            page: 0,
            attributesToRetrieve: ["name", "email", "profileImage", "born", "joined", "gender", "bio", "weight", "height", "uid", "unit"],
            responseFields: ["hits"]
          }).then(({ hits }) => {
      ...
      <View style={styles.mainWrapper}>
        <AppHeader setting={true} navigation={this.props.navigation} screenProps={this.props.screenProps} search={{
          ...
          clearIconOnPress: () => {
            ...
            this.setState({ value: "", focused: false, loading: null });
          },
          ref: this.search,
        ...
        <View style={{ flex: 1, display: "flex" }}>
          {this.state.loading === false && this.state.items.length === 0 && (<View style={{ flex: 1  }}>
            <Text style={{ fontSize: 24, color: colors.dark, marginTop: "auto", marginRight: "auto", marginLeft: "auto" }}>{this.props.screenProps.currentLang.labels.noData}</Text>
          </View>)}
          {this.state.loading === null && (<View style={{ marginLeft: "auto", marginRight: "auto", marginTop: "auto", marginBottom: 15 }}>
            <SvgComponent />
          </View>)}
